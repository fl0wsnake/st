 ...
 */
char font[] = "mono:pixelsize=14:antialias=true:autohint=true";
int borderpx = 0;
...
Shortcut shortcuts[] = {
	...
	{ MODKEY|ControlMask,   XK_l,           zoom,           {.f = +1} },
	{ MODKEY|ControlMask,   XK_h,           zoom,           {.f = -1} },
	{ MODKEY|ControlMask,	XK_r,        	zoomreset,      {.f =  0} },
